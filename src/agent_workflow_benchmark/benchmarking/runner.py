...
def _executor_context_diagnostics(run_root: Path) -> dict[str, Any] | None:
    ...
    return {
        ...
        "tool_call_types": runtime.get("tool_call_types"),
        "command_families": runtime.get("command_families"),
        "protocol_command_counts": runtime.get("protocol_command_counts"),
        "message_kind_counts": runtime.get("message_kind_counts"),
