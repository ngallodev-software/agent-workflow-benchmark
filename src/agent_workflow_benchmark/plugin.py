...
def configure(parser: argparse.ArgumentParser) -> None:
    ...
    a = c.add_parser("decision-study-adjudication-validate", help="validate one completed blinded adjudication pass against the exact view it used"); a.add_argument("view", type=Path); a.add_argument("adjudication", type=Path); a.add_argument("--study", default="routing-semantic-v1")
    a = c.add_parser("decision-study-oracle-disputes", help="compare independent A/B passes and export a C-only blinded dispute view"); a.add_argument("view", type=Path); a.add_argument("pass_a", type=Path); a.add_argument("pass_b", type=Path); a.add_argument("destination", type=Path); a.add_argument("--study", default="routing-semantic-v1"); a.add_argument("--force", action="store_true")
    a = c.add_parser("decision-study-oracle-freeze", help="assemble and freeze the independent A/B/C oracle bundle"); a.add_argument("view", type=Path); a.add_argument("pass_a", type=Path); a.add_argument("pass_b", type=Path); a.add_argument("destination", type=Path); a.add_argument("--oracle-version", required=True); a.add_argument("--c-view", type=Path); a.add_argument("--c-pass", type=Path); a.add_argument("--resolutions", type=Path); a.add_argument("--study", default="routing-semantic-v1"); a.add_argument("--force", action="store_true")
    a = c.add_parser("adjudication-module-validate", help="validate a declarative isolated A/B/C adjudication module"); a.add_argument("module", type=Path)
    a = c.add_parser("adjudication-inspect-runtime-lock", help="resolve latest Codex once and freeze the Inspect adjudicator cohort runtime"); a.add_argument("module", type=Path); a.add_argument("destination", type=Path); a.add_argument("--force", action="store_true")
    a = c.add_parser("adjudication-inspect-qualify", help="write the current Inspect pre-adjudication qualification manifest"); a.add_argument("module", type=Path); a.add_argument("destination", type=Path); a.add_argument("--runtime-lock", type=Path); a.add_argument("--force", action="store_true")
    a = c.add_parser("adjudication-inspect-qualify-live", help="run the complete synthetic Inspect P0A qualification suite"); a.add_argument("module", type=Path); a.add_argument("runtime_lock", type=Path); a.add_argument("destination", type=Path); a.add_argument("--model", required=True); a.add_argument("--model-arg", action="append", default=[]); a.add_argument("--log-model-api", action="store_true"); a.add_argument("--force", action="store_true")
    a = c.add_parser("adjudication-inspect-run-primary", help="run independent A/B adjudicators in separate Inspect sandboxes"); a.add_argument("module", type=Path); a.add_argument("view", type=Path); a.add_argument("protocol", type=Path); a.add_argument("runtime_lock", type=Path); a.add_argument("qualification", type=Path); a.add_argument("output", type=Path); a.add_argument("--model", required=True); a.add_argument("--model-arg", action="append", default=[]); a.add_argument("--log-model-api", action="store_true")
    a = c.add_parser("adjudication-inspect-run-c", help="run independent C on a dispute-only view in a fresh Inspect sandbox"); a.add_argument("module", type=Path); a.add_argument("view", type=Path); a.add_argument("protocol", type=Path); a.add_argument("runtime_lock", type=Path); a.add_argument("qualification", type=Path); a.add_argument("output", type=Path); a.add_argument("--model", required=True); a.add_argument("--model-arg", action="append", default=[]); a.add_argument("--log-model-api", action="store_true")
