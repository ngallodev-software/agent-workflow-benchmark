...
def configure(parser: argparse.ArgumentParser) -> None:
    ...
    a = c.add_parser("adjudication-inspect-run-primary", help="run independent A/B adjudicators in separate Inspect sandboxes"); a.add_argument("module", type=Path); a.add_argument("view", type=Path); a.add_argument("protocol", type=Path); a.add_argument("runtime_lock", type=Path); a.add_argument("output", type=Path); a.add_argument("--model", required=True); a.add_argument("--model-arg", action="append", default=[]); a.add_argument("--log-model-api", action="store_true")
