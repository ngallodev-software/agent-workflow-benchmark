...
def configure(parser: argparse.ArgumentParser) -> None:
    ...
    r = c.add_parser("readiness", help="validate benchmark readiness"); r.add_argument("spec", type=Path); r.add_argument("--executor", type=Path, required=True); r.add_argument("--policy", type=Path); r.add_argument("--runtime-lock", type=Path)
