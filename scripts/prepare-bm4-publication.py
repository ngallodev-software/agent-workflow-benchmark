...
PUBLIC_ARMS = {
    ...
    "workflow_full": "agent-workflow-optimized",
}
...
def sanitize_typesafe(root: Path, destination: Path) -> dict[str, Any]:
    ...
    value = {
        "schema": "agent-workflow/bm4-typesafe-public-summary/v1",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Build a sanitized BM4 publication tree for benchmark-results."
    )
    ...
    methodology = (
        "# BM4 treatment definition\n\n"
        "BM4 compares the same structured task, phase prompts, fixture, model, "
    ...
    print(f"BM4 publication tree: {destination}")
